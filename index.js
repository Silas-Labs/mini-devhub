...
const loadFromStorage=()=>{
    ...
    if (data.length == 0) {
        ...
        data?.forEach((it,index)=>{
            ...
            actions.innerHTML = `<span style='display:flex;gap:5px;'><p style='color:rgb(120,190,219);' onClick=Edit(${index})><img src="./edit.png" width=22px alt="edit"/></p><p style='color:rgb(233, 81, 81);' onClick=Delete(${index})><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 16 16">
